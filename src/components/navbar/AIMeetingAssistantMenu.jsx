...
/**
 * AI Meeting Assistant MegaMenu dropdown panel.
 * Contains direct links to all 7 independent AI Meeting Assistant pages.
 */
export default function AIMeetingAssistantMenu({ onClose }) {
  const data = navigationData.aiMeetingAssistant;
    ...
    <div className="bg-white rounded-[20px] p-6 shadow-[0_16px_32px_2px_rgba(27,30,33,0.15)] flex items-stretch gap-6 border border-[#f4f4f5] max-w-fit">
      ...
      <div className="flex gap-6">
        {data.groups.map((group, gIdx) => (
          <div key={gIdx} className="min-w-[250px] flex-1">
