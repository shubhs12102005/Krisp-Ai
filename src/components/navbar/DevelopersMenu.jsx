...
/**
 * Developers MegaMenu dropdown panel.
 * Contains direct links to all 7 independent Developers pages.
 */
export default function DevelopersMenu({ onClose }) {
  const data = navigationData.developers;
