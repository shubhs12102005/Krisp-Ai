...
/**
 * Pricing Page.
 * Transparent, predictable pricing tiers for individuals, teams, and enterprise contact centers.
 */
export default function Pricing() {
  ...
  const plans = [
    ...
    },
    {
      ...
      desc: "For professionals who want unlimited Voice AI superpowers for every meeting.",
      features: [
    ...
    },
    {
      ...
      desc: "For contact centers and organizations requiring centralized security, SSO, and compliance.",
      features: [
        "Everything in Pro",
        "Call center floor noise cancellation",
        "Accent conversion & voice translation",
        "Dedicated Customer Success Manager",
        "SSO (SAML, Okta, Azure AD)",
        "Enterprise-grade security (SOC 2, HIPAA, PCI)",
        "Centralized admin console & seat management",
        "Custom vocabulary starter kits"
      ],
      ...
      <div className="krisp-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-[1100px] mx-auto mb-24">
          {plans.map((plan, idx) => (
            <div
              key={idx}
              className={`bg-white rounded-[24px] p-8 flex flex-col justify-between transition-all duration-300 ${
                plan.highlight
